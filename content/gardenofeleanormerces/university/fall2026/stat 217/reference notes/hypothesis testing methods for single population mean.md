...
template_type: reference note
template-version: "1.18"
---
# Inspect and Adapt - Tools for Gardening

- there is a philosophy and method behind how we decide what data we gather from a statistical experiment support what conclusions. this lecture is about those methods that we use. 
